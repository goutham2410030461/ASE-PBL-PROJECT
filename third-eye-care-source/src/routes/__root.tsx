...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Third Eye Care — Patient & AI Medication Assistant" },
      {
        name: "description",
        content:
          "Add patients and get AI-reviewed medication and care guidance based on global clinical guidelines.",
      },
      { name: "author", content: "Third Eye Care" },
